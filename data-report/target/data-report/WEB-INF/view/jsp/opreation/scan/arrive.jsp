...
<html>
	<head>
		...
		<script src="${ctx }/js/operation/scan/arrive.js"></script>
				...
				<div class="textdiv">
					...
					<tr>
						...
						<td>
							...
							<input type="text" class="text txts" onkeyup="networkFuzzy(event,this,'siteId');"/>
							<input type="hidden" name="siteId" class="siteId"/>
							<label class="label" >上一站</label>
							<input type="text" class="text prev" onkeyup="networkFuzzy(event,this,'prevSiteId');"/>
					...
					<tr>
						...
						<td>
							...
							<input type="text" class=" text createBy"  name="createBy" onkeyup="employeeFuzzy(event,this,'createById');" value="${sessionScope.user.userName}"/>
