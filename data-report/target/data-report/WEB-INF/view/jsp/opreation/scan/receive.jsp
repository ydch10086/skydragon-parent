...
<script src="${ctx }/js/operation/scan/receive.js"></script>
					...
					<table>
						<tr>
							...
							<td>
								...
								<input type="text" class="text site" onkeyup="networkFuzzy(event,this,'siteId');" />
								<input type="hidden" name="siteId" class="siteId" />
							</td>
							<td>
								<label class="label">扫描人</label>
								<input type="text" class=" text createBy" name="createBy" onkeyup="employeeFuzzy(event,this,'createById');"
						...
						<tr>
							...
							<td>
								...
								<input type="text" class="text" name="sendCustomer" />
								<input type="hidden" name="sendCustomerId" class="sendCustomerId" />
							</td>
							<td>
								<label class="label">寄件客户</label>
								<input type="text" class="text" name="accepCustomer"  />
								<input type="hidden" name="accepCustomerId" class="accepCustomerId" />
							</td>
						</tr>
					</table>
				</div>
