...
<head>
	...
	<script src="${ctx }/js/operation/scan/loadCarScan.js"></script>
					...
					<table>
						...
						<tr>
							...
							<td>
								...
								<input type="text" class="text" name="plateNum"/>
							</td>
						</tr>
					</table>
				</div>
		...
		<div class="listDate" >
			<div class="data">
				<div style="min-width: 1300px;">
					...
					<div class="list">
						<table id="tbodyLoadCarList"></table>
					</div>
				</div>
			</div>
		...
		<div class="detailedInfo" style="display: none;">
			...
			<div class="data">
				<div style="min-width: 1000px;">
					...
					<div class="list">
						<table id="tbodyLoadCarInfo"></table>
					</div>
				</div>
			</div>
