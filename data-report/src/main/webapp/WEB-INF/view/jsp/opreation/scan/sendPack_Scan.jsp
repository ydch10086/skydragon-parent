...
<script src="${ctx }/js/operation/scan/sendPackScan.js"></script>
</head>
<body id="dataPage">
	<form id="subform" method="post">
					...
					<table>
						...
						<tr>
							<td>
								...
								<input type="text" name="billNo" class="text billNo" />
							</td>
							<td>
							...
							<td>
								...
								<input type="text" class="text createBy" value="${sessionScope.user.userName}" name="createBy"
									onkeyup="employeeFuzzy(event,this,'createdById');" />
								<input type="hidden" class="createdById" name="createdById" value="${sessionScope.user.userId}" />
							</td>
						</tr>
					</table>
				</div>
		...
		<div class="data">
			<div style="min-width: 1000px;">
				...
				<div class="list">
					<table id="tbody_sendPackScanDisplayId"></table>
				</div>
			</div>
		</div>
		<div class="page">
