...
<script src="${ctx }/js/operation/scan/signScan.js"></script>
</head>
<body id="dataPage">
	<form id="subform" method="post">
				...
				<div class="textdiv">
					...
					<tr>
						...
						<td width="240px">
							...
							<input type="text" class="text scanSiteName" name="scanSiteName" onkeyup="networkFuzzy(event,this,'scanSiteId');"/>
							<input type="hidden" class="scanSiteId" name="scanSiteId"/>
						</td>
						<td>
							<label class="label" >寄件网点</label>
							<input type="text" class="text sendSite" name="sendSite" onkeyup="networkFuzzy(event,this,'sendSiteId');"/>
							<input type="hidden" class="sendSiteId" name="sendSiteId"/>
						</td>
					</tr>
					<tr>
						<td><label class="label" style="margin-left: 0px;">输入单号</label>
						...
						<td>
							...
							<input type="text" class="text createBy" name="createBy" value="${sessionScope.user.userName}" onkeyup="employeeFuzzy(event,this,'dispatchEmployeeId');"/>
							<input type="hidden" class="dispatchEmployeeId" name="dispatchEmployeeId" value="${sessionScope.user.userId}"/>
						</td>
						<td>
							<label class="label">派件人</label>
							<input type="text" class="text dispatchEmployeeName" name="dispatchEmployeeName" onkeyup="employeeFuzzy(event,this,'deliveryManId');">
							<input type="hidden" class="deliveryManId" name="deliveryManId"/>
						</td>
					</tr>
				</table>
				</div>
		...
		<div class="data">
			<div style="min-width: 1000px;">
				...
				<div class="list">
					<table id="tbody_signScanDisplayId"></table>
				</div>
			</div>
		</div>
		<div class="page">
