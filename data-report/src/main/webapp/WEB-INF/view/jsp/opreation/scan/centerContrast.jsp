...
<html>
	<head>
		...
		<script src="${ctx }/js/operation/scan/centerContrast.js"></script>
				...
				<div class="textdiv">
					...
					<tr>
						...
						<td>
							...
							<select class="queryType" name="queryType" id="queryType" style="width: 142px; height: 23px">
								<option value="1" selected="selected">本站有到-上站未发</option>
								<option value="2">本站有发-下站未到</option>
							</select>
						</td>
					</tr>
				</table>
